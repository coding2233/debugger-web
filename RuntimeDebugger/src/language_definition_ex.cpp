...
const TextEditor::LanguageDefinition& LanguageDefinitionExCSharp()
{
...
const TextEditor::LanguageDefinition& GetLanguageDefinitionEx(const char* def_name)
{

    return LanguageDefinitionExCSharp();
}