...
if is_plat("wasm") then
    ...
    target("RuntimeDebugger")
        ...
        add_files("protobuf-wasm-v21.12/libprotobuf.a","protobuf-wasm-v21.12/libprotoc.a","protobuf-wasm-v21.12/libprotobuf-lite.a");
        add_includedirs("protobuf-wasm-v21.12/include")
